...
def main(fasta_path, graphpart_csv, out_dir, train_size, val_size, test_size, mmseqs_threshold):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Split with MMseqs2 deduplication between train and temp (val+test).")
    ...
    main(args.fasta, args.graphpart_csv, args.out_dir, args.train_size, args.val_size, args.test_size, args.mmseqs_threshold)